                            ...
                            <div class="table-responsive">
                                <table id="tblUsuario" class="table table-hover table-sm isDataTable withOutAutoFit isAjaxTable" 
                                    ...
                                    <thead class="bg-blue-light text-white">
                                        <tr>
                                            <th class="text-center" data-column-orde="0" data-key="idUsuario">ID</th>
                                            <th class="text-center" data-column-orde="1" data-key="usuario">Código</th>
                                            <th class="text-center" data-column-orde="2" data-visible="false" data-key="contrasena">Contraseña</th>
                                            <th class="text-center" data-column-orde="3" data-visible="false" data-key="fecVtoContrasena">Venc. Contraseña</th>
                                            <th class="text-center" data-column-orde="4" data-visible="false" data-key="idPersona.idPersona">ID Persona</th>
                                            <th class="text-center" data-column-orde="5" data-key="idPersona.nombres">Nombres</th>
                                            <th class="text-center" data-column-orde="6" data-key="idPersona.apellidos">Apellidos</th>
                                            <th class="text-center" data-column-orde="7" data-visible="false" data-key="idPersona.fecNacimiento">Fecha Nacimiento</th>
                                            <th class="text-center" data-column-orde="8" data-key="idPersona.documentoId">Documento No.</th>
                                            <th class="text-center" data-column-orde="9" data-visible="false" data-key="idPersona.idTipoDocumento.idTipoDocumento">ID Tipo Documento</th>
                                            <th class="text-center" data-column-orde="10" data-key="idPersona.idTipoDocumento.descripcion">Tipo Documento</th>
                                            <th class="text-center" data-column-orde="11" data-key="idPersona.sexo">Sexo</th>
                                            <th class="text-center" data-column-orde="12" data-key="idPersona.direccion">Dirección</th>
                                            <th class="text-center" data-column-orde="13" data-key="idPersona.telefonos">Telefonos</th>
