<%-- 
    Document   : Especializacion
    Created on : 20/10/2020, 05:15:19 AM
    Author     : DOxlaj
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="table-responsive">
                                <table id="tblEspecializacion" class="table table-hover table-sm isDataTable withOutAutoFit isAjaxTable" 
                                       data-url="<%= request.getContextPath()%>/EspecializacionController" data-method="GET" data-src=""
                                       data-show-buttons="true">
                                    <thead class="bg-blue-light text-white">
                                        <tr>
                                            <th class="text-center" data-key="idEspecializacion">Código</th>
            ...
            <div id="mainEspecializacionModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="tipoDocumentoMaintenance" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header bg-blue-light text-white">
                            <h5 class="modal-title" id="exampleModalLabel">Agregar / Editar Especialización</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form id="frmEspecializacionMant">
                                <div class="row">
