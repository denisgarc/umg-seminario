...
var $modalId = 'mainUsuarioModal';
var $formAuxId = 'frmUsuarioMant';
var $formPersonId = 'frmPersona';
var $tableId = 'tblUsuario';
            ...
            case "delete":
                ShowConfirmationDialog('¿Está seguro de deshabilitar el registro?').then((isOk) => {
                    if (isOk) {
                        ...
                        data.fecVtoContrasena = new Date(data.fecVtoContrasena).toStringDMY();
                        aaveDelete(data, 'E');
                    }
                }).catch((err) => {
                    console.error(err);
