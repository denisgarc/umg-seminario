...
<html>
    ...
    <body>
        ...
        <div class="">
            <div class="card">
                <h3 class="card-header text-center bg-secondary text-white">Reporte de Pacientes</h3>
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="table-responsive">
                                <table id="tblPaciente" class="table table-hover table-sm isDataTable withOutAutoFit isAjaxTable" 
                                       data-url="<%= request.getContextPath()%>/PacienteReporteController" data-method="GET" data-src=""
                                       data-show-buttons="true">
                                    <thead class="bg-blue-light text-white">
                                        <tr>
                                            <th class="text-center" data-key="total">Total</th>
