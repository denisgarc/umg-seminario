...
(
  ...
  CONSTRAINT FK_CITA_HOSPITAL 
    FOREIGN KEY (ID_HOSPITAL) 
    REFERENCES ErmitaCitasDB.HOSPITAL (ID_HOSPITAL),
  CONSTRAINT FK_CITA_H_CLINICA 
    FOREIGN KEY (ID_HOSPITAL, ID_CLINICA) 
    REFERENCES ErmitaCitasDB.HOSPITAL_CLINICA (ID_HOSPITAL, ID_CLINICA),
  CONSTRAINT FK_CITA_H_SALA 
    FOREIGN KEY (ID_HOSPITAL, ID_SALA) 
    REFERENCES ErmitaCitasDB.HOSPITAL_SALA (ID_HOSPITAL, ID_SALA),
